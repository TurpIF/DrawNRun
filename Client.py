...
class App(object):
    ...
    def Update(self):
        ...
        self.score = int(self.lsController[0].player.x/10)
    ...
    def GameOver(self, i):
        ...
        txt = sf.String( "GAME OVER ! Player {} wins".format((i+1)%2), App.minecrafter, 40 )
        x, y = self.renderWindow.GetWidth() / 2 - 500,  self.renderWindow.GetHeight()/2 - 80
        score = sf.String( "with {} points".format(self.lsController[(i+1)%2].player.point), App.minecrafter, 35 )
    ...
    def ShowScore(self, score, offset):
        ...
        x, y = self.renderWindow.GetWidth() / 2 - 150,  20 + offset
